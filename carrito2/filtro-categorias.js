...
(function () {
  ...
  ready(function () {
    ...
    if (!toolbar) {
      ...
      grid.parentNode.insertBefore(toolbar, grid); // arriba del grid
    }
    ...
    // Aplicar desde URL (?cat=consolas) o localStorage
    ...
    function aplicarFiltro() {
      ...
      // Actualiza querystring sin recargar (bonito para compartir enlaces)
